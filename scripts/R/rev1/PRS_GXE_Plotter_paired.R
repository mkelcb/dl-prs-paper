...
outputLoc = "C:/0LocalHPC/PRS_GXE/310124/local/finalRes_resPaired"
plotName="PRS_GxE_non-linearity"
...
# make dots paired by adding segments in base R: /www.r-bloggers.com/2011/06/visualizing-small-scale-paired-data-combining-boxplots-stripcharts-and-confidence-intervals-in-r/
segments(rep(VEC[1],length(inputDatas_mat[[1]])),inputDatas_mat[[1]],rep(VEC[2],length(inputDatas_mat[[4]])),inputDatas_mat[[2]],col="grey",lwd=1, lt = 2)
segments(rep(VEC[3],length(inputDatas_mat[[3]])),inputDatas_mat[[3]],rep(VEC[4],length(inputDatas_mat[[4]])),inputDatas_mat[[4]],col="grey",lwd=1, lt = 2)
